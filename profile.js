...
function loadProfile() {
  ...
  // Stats
  document.getElementById('psTxCount').textContent = getExpenses().length;
  document.getElementById('psGoals').textContent = getGoals().length;
  document.getElementById('psAccounts').textContent = getAccounts().length;
